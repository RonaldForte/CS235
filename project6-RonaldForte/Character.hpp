...
class Character
{
    public:
        ...
        */
        ...
        void throwTomato(Character*);

        //ActionSelectionHelper functions. See tavern hpp
        //for printing turn
        void actionSelectionHelp2(int action);
        void actionSelectionClear();

        //turn res Helper
        std::queue<int> getActionQueue();
        std::stack<Buff> getBuffs();

        bool isBuffEmpty() const;
    ...
    private:
        ...
        std::queue<int> action_;

        std::stack<Buff> buff_;
